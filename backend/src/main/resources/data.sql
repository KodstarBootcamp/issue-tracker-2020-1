insert into USERS (id, created_at, modified_at, email, password, username)
...
insert into ISSUE (id, created_at, modified_at, description, category, state, title, project_id,user_id)
values ('1', '2018-08-17 07:42:44.136', '2018-08-17 07:42:44.136', 'description 1', 'BACKLOG', 'OPEN', 'test issue 1',1,1);
insert into ISSUE (id, created_at, modified_at, description, category, state, title, project_id,user_id)
values ('2', '2018-08-19 09:12:44.136', '2018-08-19 09:12:44.136', 'description 2', 'REVIEW', 'OPEN', 'test issue 2',1,2);
insert into ISSUE (id, created_at, modified_at, description, category, state, title, project_id,user_id)
values ('3', '2018-09-21 07:42:44.136', '2018-09-21 07:42:44.136', 'description 3', 'FINISHED', 'OPEN', 'test issue 3',2,1);
